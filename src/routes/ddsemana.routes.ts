...
import { atualizarDDSemanaController, createDDSemanaController, deletarDDSemanaController, getAllDDSemanaController } from "../controller/ddsemana.controller";
...
DDSemanaRoutes.patch("/:id", atualizarDDSemanaController)